...
const (
	AuthorityService_Signup_FullMethodName         = "/mercari.mercari_microservices_example.authority.AuthorityService/Signup"
	AuthorityService_Signin_FullMethodName         = "/mercari.mercari_microservices_example.authority.AuthorityService/Signin"
	AuthorityService_ListPublicKeys_FullMethodName = "/mercari.mercari_microservices_example.authority.AuthorityService/ListPublicKeys"
)
...
func (c *authorityServiceClient) ListPublicKeys(ctx context.Context, in *ListPublicKeysRequest, opts ...grpc.CallOption) (*ListPublicKeysResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorityService_ListPublicKeys_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthorityService_ListPublicKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorityService_ListPublicKeys_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
