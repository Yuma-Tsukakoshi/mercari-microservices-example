...
const (
	ItemService_CreateItem_FullMethodName = "/mercari.mercari_microservices_example.item.ItemService/CreateItem"
	ItemService_GetItem_FullMethodName    = "/mercari.mercari_microservices_example.item.ItemService/GetItem"
	ItemService_ListItems_FullMethodName  = "/mercari.mercari_microservices_example.item.ItemService/ListItems"
)
